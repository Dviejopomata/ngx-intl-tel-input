(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('libphonenumber-js/examples.mobile.json'), require('libphonenumber-js'), require('@angular/core'), require('@angular/common'), require('ngx-bootstrap'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('ngx-intl-tel-input', ['exports', 'libphonenumber-js/examples.mobile.json', 'libphonenumber-js', '@angular/core', '@angular/common', 'ngx-bootstrap', '@angular/forms'], factory) :
    (factory((global['ngx-intl-tel-input'] = {}),global.examples,global['^1']['7']['8'],global.ng.core,global.ng.common,global['^3']['1']['3'],global.ng.forms));
}(this, (function (exports,examples,libphonenumberJs,i0,common,ngxBootstrap,forms) { 'use strict';
    ...
    var phoneNumberValidator = function (control) {
        ...
        var number;
        try {
            number = libphonenumberJs.parse(control.value.number, control.value.countryCode);
        }
        catch (e) {
            return error;
        }
    ...
    var NgxIntlTelInputComponent = /** @class */ (function () {
         ...
         */
            function () {
                ...
                var number;
                try {
                    number = libphonenumberJs.parse(this.phoneNumber, this.selectedCountry.iso2);
                }
                catch (e) {
                }
                /** @type {?} */
                ...
                /** @type {?} */
                var internationalNumber = number ? libphonenumberJs.format(number, 'INTERNATIONAL') : '';
                /** @type {?} */
                var nationalNumber = number ? libphonenumberJs.format(number, 'NATIONAL') : '';
         ...
         */
            function (countryCode) {
                try {
                    /** @type {?} */
                    var example = libphonenumberJs.getExampleNumber(countryCode, ( /** @type {?} */(examples)));
                    return libphonenumberJs.format(example.number, countryCode, 'INTERNATIONAL');
                }
                catch (e) {
